    ...
    <view class="chat_list" id="chatList">
      <view class="chat_item-left">
        ...
        <view class="chat_container">
          ...
          <button open-type="chooseAvatar" @chooseavatar="onChooseAvatar" class="chat_extra-age"
            v-if="avatarUrl === ''">
            请点击获取用户头像
          </button>
        </view>
      ...
      <view class="chat_item-left" v-if="threeQuestion">
        ...
        <view class="chat_container">
          ...
          <up-datetime-picker :formatter="formatter" :show="calendarShow" :min-date="minDate" :max-date="maxDate"
            mode="date" v-model="dateval" ref="datetimePickerRef" class="chat_extra-age" @confirm="handleConfirm"
      ...
      <view class="chat_submit_btn" @click="handleSubmit" v-if="fourQuestion" :class="{ 'fade-in': fourQuestion }">
        同意协议，完成身份注册
      </view>
      <view id="anchor"></view>
    </view>
